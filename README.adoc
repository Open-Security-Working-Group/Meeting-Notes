...
| SUSE | Knut Trepte | Product Manager - Security | OS | knut.trepte@suse.com
...
| SUSE | Chris Beaudet | Pre-Sales Engineer | Both | chris.beaudet@rancherfederal.com
...
| CIS | Eric Pinnell | Cybersecurity Engineer | Both | eric.pinnell@cisecurity.org
